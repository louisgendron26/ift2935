...
public class WindowShare {
	...
	private JPanel searchObjResultPanel;
	...
	private void initialize() {
		...
		springLayout.putConstraint(SpringLayout.EAST, afterLogPanel, 877, SpringLayout.WEST, frame.getContentPane());
		...
		afterLogPanel.add(borrowPanel);
				...
				sl_afterLogPanel.putConstraint(SpringLayout.NORTH, shareObjectPanel, 0, SpringLayout.SOUTH, borrowPanel);
				...
				sl_afterLogPanel.putConstraint(SpringLayout.EAST, shareObjectPanel, -567, SpringLayout.EAST, afterLogPanel);
				...
				sl_shareObjectPanel.putConstraint(SpringLayout.SOUTH, chooseTypeSharepanel, 258, SpringLayout.SOUTH, shareObjectTitleLabel);
				sl_shareObjectPanel.putConstraint(SpringLayout.EAST, chooseTypeSharepanel, 275, SpringLayout.WEST, shareObjectPanel);
				...
				sl_shareObjectPanel.putConstraint(SpringLayout.EAST, shareCarTypePanel, 275, SpringLayout.WEST, shareObjectPanel);
				shareCarTypePanel.setVisible(false);
				...
				sl_shareObjectPanel.putConstraint(SpringLayout.SOUTH, shareCarTypePanel, 258, SpringLayout.SOUTH, shareObjectTitleLabel);
				...
				sl_shareObjectPanel.putConstraint(SpringLayout.EAST, shareHouseTypePanel, 275, SpringLayout.WEST, shareObjectPanel);
				shareHouseTypePanel.setVisible(false);
				...
				sl_shareObjectPanel.putConstraint(SpringLayout.SOUTH, shareHouseTypePanel, 258, SpringLayout.SOUTH, shareObjectTitleLabel);
				...
				sl_shareObjectPanel.putConstraint(SpringLayout.EAST, shareBikeTypePanel, 275, SpringLayout.WEST, shareObjectPanel);
				shareBikeTypePanel.setVisible(false);
				...
				sl_shareObjectPanel.putConstraint(SpringLayout.SOUTH, shareBikeTypePanel, 258, SpringLayout.SOUTH, shareObjectTitleLabel);
				...
				sl_afterLogPanel.putConstraint(SpringLayout.NORTH, searchObjectPanel, 8, SpringLayout.SOUTH, giveBackPanel);
				sl_afterLogPanel.putConstraint(SpringLayout.WEST, searchObjectPanel, 6, SpringLayout.EAST, shareObjectPanel);
				sl_afterLogPanel.putConstraint(SpringLayout.SOUTH, searchObjectPanel, 0, SpringLayout.SOUTH, shareObjectPanel);
				sl_afterLogPanel.putConstraint(SpringLayout.EAST, searchObjectPanel, 281, SpringLayout.EAST, shareObjectPanel);
				afterLogPanel.add(searchObjectPanel);
				SpringLayout sl_searchObjectPanel = new SpringLayout();
				searchObjectPanel.setLayout(sl_searchObjectPanel);
				
				JPanel searchObjPanel = new JPanel();
				sl_searchObjectPanel.putConstraint(SpringLayout.NORTH, searchObjPanel, 0, SpringLayout.NORTH, searchObjectPanel);
				sl_searchObjectPanel.putConstraint(SpringLayout.WEST, searchObjPanel, 0, SpringLayout.WEST, searchObjectPanel);
				sl_searchObjectPanel.putConstraint(SpringLayout.SOUTH, searchObjPanel, 0, SpringLayout.SOUTH, searchObjectPanel);
				sl_searchObjectPanel.putConstraint(SpringLayout.EAST, searchObjPanel, 135, SpringLayout.WEST, searchObjectPanel);
				searchObjectPanel.add(searchObjPanel);
				
				searchObjResultPanel = new JPanel();
				sl_searchObjectPanel.putConstraint(SpringLayout.NORTH, searchObjResultPanel, 0, SpringLayout.NORTH, searchObjectPanel);
				sl_searchObjectPanel.putConstraint(SpringLayout.WEST, searchObjResultPanel, 6, SpringLayout.EAST, searchObjPanel);
				sl_searchObjectPanel.putConstraint(SpringLayout.SOUTH, searchObjResultPanel, 309, SpringLayout.NORTH, searchObjectPanel);
				sl_searchObjectPanel.putConstraint(SpringLayout.EAST, searchObjResultPanel, -10, SpringLayout.EAST, searchObjectPanel);
				searchObjectPanel.add(searchObjResultPanel);
